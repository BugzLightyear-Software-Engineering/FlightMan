...
public class AirportController {
	...
	public ResponseEntity<?> getAirports(@RequestParam(required = false) String airportName) {
        ...
        */
        ...
        public ResponseEntity<?> createAirport(String airportName, String airportAbvName, String latitude, String longitude)   
        {
                ...
                if(airportAbvName.length() != 3){
                        return new ResponseEntity<>("Airport ABV Name must be exactly 3 characters", HttpStatus.BAD_REQUEST);
                }
                try {
                        if(this.airportService.saveAirport(airportName, airportAbvName, latitude, longitude)){
